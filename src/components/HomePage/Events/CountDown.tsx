...
const COUNTDOWN_FROM = "2024-12-20";
...
const ShiftingCountdown = () => {
  return (
    <div className=" p-4">
      <div className="mx-auto flex w-full max-w-5xl bg-transparent">
...
const CountdownItem = ({ unit, text }: { unit: Units; text: string }) => {
  ...
  return (
    <div className="countdown-box flex w-1/4 flex-col items-center justify-center gap-1 border-r-[1px] border-slate-200 font-mono md:gap-2">
